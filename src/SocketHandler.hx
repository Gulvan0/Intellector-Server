...
class SocketHandler extends WebSocketHandler
{
    ...
    private function handlerActive(eventName:String) 
    {
        return switch ustate 
        {
            ...
            case MainMenu: ['callout', 'accept_challenge', 'message', 'decline_challenge', 'cancel_callout', 'open_callout', 'cancel_open_callout', 'get_game', 'get_challenge', 'accept_open_challenge', 'spectate', 'stop_spectate'].has(eventName);
