...
class CorrespondenceGame extends Game
{
    public static function createNew(id:Int, players:Map<PieceColor, UserSession>, rated:Bool, ?customStartingSituation:Situation, ?botHandle:String):CorrespondenceGame
    {
        ...
        game.log = GameLog.createNew(id, players, Correspondence, rated, customStartingSituation, botHandle);
    ...
    {
        if (!log.ongoing || !log.timeControl.match(Correspondence))
            return null;
    ...
    private function new(id:Int) 
    {
        ...
        this.time = GameTimeFactory.build(Correspondence, true, c -> {});
    }
}